...
SECRET_KEY = 'django-insecure-jnz%f((bbb*@8rpibfjmbybtlqw=j^a3d29w(f1=(+*2xt=^te'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['172.20.176.1', 'localhost', '127.0.0.1']
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'videochat.authentication.BearerAuthentication'
    ]
}
